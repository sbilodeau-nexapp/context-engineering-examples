...
|---------|------|---------|
| `backend/` | NestJS 10 + Prisma 5 + PostgreSQL API | NestJS Rest API for CRUD operation |
| `frontend/` | React 19, Vite 6, EmotionCSS TanStack Query, i18next | React frontend |
| `infra/` | AWS, Pulumi | Deployment and Infra |
